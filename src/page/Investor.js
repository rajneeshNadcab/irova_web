        ...
        <div style={{ marginTop: "80px", fontFamily: "initial" }} id="h4">
          <div className="container" style={{ padding: "5px 233px" }}>
            ...
            <p style={{ marginLeft: "20px" }}>
              ...
              optimize investor impact while maximizing the value and growth
            ...
            <p style={{ marginLeft: "20px" }}>
              <strong>Structured for Success:</strong> We've meticulously
              structured this share allocation to ensure each investor, limited
              to a maximum of 100, gains substantial influence and potential for
              high returns. The minimum investment of $10,000 makes this
              opportunity accessible to a diverse range of investors while
              maintaining a high standard of commitment and ensuring significant
              stakes for each participant.
            </p>
            <p style={{ marginLeft: "20px" }}>
              ...
              critical, expanding user demand.
            </p>
            <p style={{ marginLeft: "20px" }}>
              This share allocation and cost structure are not just numbers;
              they represent an opportunity to be part of a future-focused
              venture, designed for growth, and primed to meet the challenges
            ...
            <p style={{ marginLeft: "20px" }}>
              ...
              investors who are not just financially capable but also share our
              vision for a privacy-centric, decentralized communication future.
              To this end, eligibility extends to a select group of up to 100
              investors. This limitation is intentional, aimed at maintaining a
              focused and dedicated investment community.
            </p>
            <p style={{ marginLeft: "20px" }}>
              <strong>Minimum Investment Threshold:</strong> The minimum
              investment of $10,000 is set to ensure that every investor holds a
              stake significant enough to feel personally invested in the app's
              success. This threshold strikes a balance between making the
              opportunity accessible to a diverse investor base and ensuring
              each investment carries substantial weight and value.
            </p>
            <p style={{ marginLeft: "20px" }}>
            ...
            <p style={{ marginLeft: "20px" }}>
              ...
              a robust reporting system that provides both monthly and quarterly
              reports to our valued investors.
            </p>
            <div>
              <p style={{ marginLeft: "20px" }}>
                ...
                <li style={{ marginLeft: "20px" }}>
                  ...
                  evolution, allowing investors to stay up-to-date with our
                  development journey.
                </li>
              </p>

              <p style={{ marginLeft: "20px" }}>
                <strong>Quarterly Profit Sharing:</strong>
              ...
              <p style={{ marginLeft: "20px" }}>
                <strong>Empowering Informed Decisions:</strong>
                <li style={{ marginLeft: "20px" }}>
              ...
              <p style={{ marginLeft: "20px" }}>
                ...
                <li style={{ marginLeft: "20px" }}>
                  By offering both monthly and quarterly reports, we invite you
                  to join us on this exciting journey of growth and innovation.
                  We aim to foster a sense of partnership and collaboration,
                  where your investment isn't just a financial commitment but a
                  shared experience in building something extraordinary.
                </li>
              </p>
              <p style={{ marginLeft: "20px" }}>
            ...
            <div>
              ...
              <div style={{ marginLeft: "20px" }}>
                ...
                <p>
                  <strong>Calculating Profits:</strong>
                  <ul>
                    <li>
                ...
                <p>
                  <strong>Proportional Distribution:</strong>
                  <ul>
                    <li>
                      Profit shares will be distributed proportionally based on
                      the amount invested by each investor. This means that your
                      financial contribution directly influences your share of
                      the profits.
                    </li>
                  </ul>
                </p>
            ...
            <div>
              ...
              <div style={{ marginLeft: "20px" }}>
                ...
                <strong>Sustainable Profitability:</strong>
                <ul>
                  <li>
                    Our long-term vision is rooted in sustainable profitability.
                    By sharing profits with our investors, we aim to create a
                    mutually beneficial relationship that lasts for years to
                    come.
                  </li>
                </ul>
                ...
                <strong>Investment for Generations:</strong>
                <ul>
                  <li>
            ...
            <div>
              ...
              <div style={{ marginLeft: "20px" }}>
                ...
                <p>
                  <strong>1. Eligibility and Minimum Investment:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>2. Share Allocation and Cost:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>3. Monthly and Quarterly Reports:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>4. Profit Sharing Mechanism:</strong>
                </p>
                <ul>
                  <li>
                    Profits will be shared proportionally among investors after
                    deducting operational and developmental costs.
                  </li>
                </ul>
                <p>
                  <strong>5. Long-Term Investment Vision:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>6. Investment Support and Resources:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>7. Policy Amendments:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>8. Withdrawal and Termination:</strong>
                </p>
                <ul>
                  <li>
                    Withdrawal and termination policies will be detailed
                    separately, outlining the process for exiting the investment
                    if necessary.
                  </li>
                </ul>
                <p>
                  <strong>9. Legal Framework:</strong>
                </p>
                <ul>
                  <li>
                    This investment is subject to the legal framework governing
                    financial transactions and investments in your jurisdiction.
                  </li>
                </ul>
                <p>
                  <strong>10. Responsibility of Investors:</strong>
                </p>
                <ul>
                  <li>
                ...
                <ul>
                  <li>
                    ...
                    sensitive investment and financial information.
                  </li>
                </ul>
                <p>
                ...
                <ul>
                  <li>
                    ...
                    as detailed in the dispute resolution policy.
                  </li>
                </ul>
            ...
            <div>
              ...
              <div style={{ marginLeft: "20px" }}>
                ...
                <p>
                  <strong>1. Eligibility Check:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>2. Expression of Interest:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>3. Information Package:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>4. Review and Due Diligence:</strong>
                </p>
                <ul>
                  <li>
                    Take the time to review the provided information and conduct
                    your due diligence. You may seek legal or financial advice
                    if necessary to make an informed decision.
                  </li>
                </ul>
                <p>
                  <strong>5. Application Submission:</strong>
                </p>
                <ul>
                  <li>
                    If you decide to proceed with the investment, submit your
                    formal application through the designated channel. This
                    application will include your investment amount and other
                    required details.
                  </li>
                </ul>
                <p>
                  <strong>6. Confirmation:</strong>
                </p>
                <ul>
                  <li>
                    Once your application is received, you will receive a
                    confirmation of receipt, acknowledging your intent to
                    invest.
                  </li>
                </ul>
                <p>
                  <strong>7. Allocation of Shares:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>8. Investment Confirmation:</strong>
                </p>
                <ul>
                  <li>
                    You will receive an investment confirmation, indicating the
                    number of shares allocated and the corresponding investment
                    amount.
                  </li>
                </ul>
                <p>
                  <strong>9. Investment Agreement:</strong>
                </p>
                <ul>
                  <li>
                    Sign the investment agreement, which outlines the terms and
                    conditions of your investment. This agreement is a legally
                    binding document.
                  </li>
                </ul>
                <p>
                  <strong>10. Investment Funding:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>11. Welcome to the Investor Community:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>12. Ongoing Support:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>13. Profit Sharing:</strong>
                </p>
                <ul>
                  <li>
            ...
            <div>
              ...
              <div style={{ marginLeft: "20px" }}>
                ...
                <ul>
                  <li>
                    Upon notification, investors will be given a reasonable
                    review period to familiarize themselves with the proposed
                    policy amendments and assess their potential impact on their
                    investments.
                  </li>
                </ul>
                <p>
                  <strong>3. Investor Input:</strong>
                </p>
                <ul>
                  <li>
                ...
                <ul>
                  <li>
                    After the review period, if the majority of investors
                    consent to the proposed policy amendments, they will be
                    implemented according to the communicated timeline.
                  </li>
                </ul>
                <p>
                  <strong>5. Grandfathering Provisions:</strong>
                </p>
                <ul>
                  <li>
                    In some cases, policy amendments may include grandfathering
                    provisions. These provisions may exempt existing investors
                    from certain changes, preserving their original terms and
                    conditions.
                  </li>
                </ul>
                <p>
                  <strong>6. Continuous Communication:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>8. Upholding Fairness:</strong>
                </p>
                <ul>
                  <li>
                ...
                <p>
                  <strong>9. Right to Dissent:</strong>
                </p>
                <ul>
                  <li>
                    Investors who do not agree with proposed policy amendments
                    have the right to dissent and may choose to exit their
                    investment following the outlined withdrawal procedures.
                  </li>
                </ul>
                <p>
